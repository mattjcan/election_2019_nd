...
# Strong primary vote across Dawson
...
# But there were mixed swings on primaries
...
# Leaving a strong TPP outcome in Dawson
...
``` {r }
grid.arrange(p_prim_daw_lnp_sub$Airlie, p_prim_daw_lnp_sub$Bowen, p_prim_daw_lnp_sub$Burdekin, p_prim_daw_lnp_sub$Townsville, ncol = 2)
```
...
``` {r }
grid.arrange(p_prim_daw_lnp_sub$`Mackay - north`, p_prim_daw_lnp_sub$`Mackay - south`, p_prim_daw_lnp_sub$Islands, p_prim_daw_lnp_sub$Rural, ncol = 2)
```
...
``` {r }
grid.arrange(p_prim_daw_alp_sub$Airlie, p_prim_daw_alp_sub$Bowen, p_prim_daw_alp_sub$Burdekin, p_prim_daw_alp_sub$Townsville, ncol = 2)
```
...
``` {r }
grid.arrange(p_prim_daw_alp_sub$`Mackay - north`, p_prim_daw_alp_sub$`Mackay - south`, p_prim_daw_alp_sub$Islands, p_prim_daw_alp_sub$Rural, ncol = 2)
```
...
```{r }
frameWidget(m_daw_tpp, width='100%', height = '500px')
```
...
```{r }
frameWidget(m_daw, width='100%', height = '500px')
```
...
```{r }
frameWidget(m_daw_prim, width='100%', height = '500px')
```
...
```{r }
frameWidget(m_daw_prim_s, width='100%', height = '500px')
```
